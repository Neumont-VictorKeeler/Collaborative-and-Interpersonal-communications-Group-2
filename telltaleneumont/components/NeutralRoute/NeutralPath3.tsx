...
const differences: Difference[] = [
  { x: 0.48, y: 0.63, radius: 0.04 },
  { x: 0.50, y: 0.81, radius: 0.05 },
  { x: 0.39, y: 0.72, radius: 0.04 },
  { x: 0.92, y: 0.63, radius: 0.07 },
  { x: 0.09, y: 0.67, radius: 0.07 },
  { x: 0.39, y: 0.55, radius: 0.04 },
];

export default function NeutralPath3({ goTo }: { goTo: (page: number) => void }) {
    ...
    <div className="w-screen h-screen bg-black flex flex-col items-center justify-center p-4">
      ...
      <div className="flex flex-col md:flex-row gap-4 w-full h-full max-w-6xl">
        ...
        <div className="flex-1 flex items-center justify-center">
          <img
            src="/images/Clean_Apartment.png"
            alt="Picture 1"
        ...
        >
          <img
            src="/images/Dirty_Apartment.png"
            alt="Picture 2"
            className="w-full h-auto object-contain border-4 border-yellow-500 rounded-lg shadow-lg"
          />
