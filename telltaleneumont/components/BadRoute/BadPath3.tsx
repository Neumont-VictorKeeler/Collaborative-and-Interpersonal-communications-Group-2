...
const differences: Difference[] = [
  { x: 0.18, y: 0.59, radius: 0.04 },
  { x: 0.81, y: 0.52, radius: 0.04 },
  { x: 0.19, y: 0.42, radius: 0.04 },
  { x: 0.65, y: 0.63, radius: 0.07 },
  { x: 0.06, y: 0.63, radius: 0.04 },
  { x: 0.28, y: 0.79, radius: 0.05 },
  { x: 0.38, y: 0.78, radius: 0.02 },
  { x: 0.58, y: 0.80, radius: 0.07 },
  { x: 0.80, y: 0.77, radius: 0.07 },
  { x: 0.27, y: 0.55, radius: 0.06 },
  { x: 0.39, y: 0.51, radius: 0.04 },
  { x: 0.57, y: 0.50, radius: 0.05 },
  { x: 0.02, y: 0.68, radius: 0.02 },
  { x: 0.39, y: 0.65, radius: 0.06 },
  { x: 0.50, y: 0.61, radius: 0.03 },
  { x: 0.90, y: 0.42, radius: 0.05 },
];

export default function BadPath3({ goTo }: { goTo: (page: number) => void }) {
